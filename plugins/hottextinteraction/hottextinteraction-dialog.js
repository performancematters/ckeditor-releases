				...
				elements: [
					{
						...
						html: '<div class="hottextinteraction-dialog">' +
							...
							'<ul></ul>' +
							'<div class="hottextinteraction-shuffle"><label><input type="checkbox" class="hottextinteraction-shuffleinput">Shuffle unlocked choices when this item is presented.</label></div>' +
							'</div>',
